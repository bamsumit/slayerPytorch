...
def genLoihiParams(net):
	...
	np.save('Trained/fc1.txt'  , fc1Weights)
	np.save('Trained/fc2.txt'  , fc2Weights)
	np.save('Trained/conv1.txt', conv1Weights)
	np.save('Trained/conv2.txt', conv2Weights)
	np.save('Trained/pool1.txt', pool1Weights)
	np.save('Trained/pool2.txt', pool2Weights)
	np.save('Trained/pool3.txt', pool3Weights)
